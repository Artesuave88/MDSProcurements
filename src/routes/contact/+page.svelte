    ...
    <div class="p-6 w-full mx-auto">
      <div class="bg-white p-6 rounded-lg shadow-md w-1/2 mx-auto">
        ...
        <form on:submit|preventDefault={handleSubmit} class="space-y-6">
          ...
          <button
            class="bg-blue-500 text-white p-4 rounded-lg w-1/3 mt-4 disabled:opacity-50 hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 justify-end mx-auto"
            type="submit"
